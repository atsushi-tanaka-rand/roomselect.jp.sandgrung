// 自動追客メールテンプレートトリガー
trigger BF101001Trigger on AutoPursuitMailTemplate__c(before insert, after insert, before update, after update, 					
before delete, after delete, after undelete) {					
	...
	BF101001TriggerHandler handler = new BF101001TriggerHandler(Trigger.isExecuting, Trigger.size);	
