//建物トリガ
trigger BD301003Trigger on Building__c (before insert, after insert, before update, after update,                   
 before delete, after delete, after undelete) {                 
  ...
  BD301003TriggerHandler handler = new BD301003TriggerHandler(Trigger.isExecuting, Trigger.size);   
