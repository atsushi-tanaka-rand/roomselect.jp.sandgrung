trigger BD301004Trigger on PropertyConditions__c (before insert, after insert, before update, after update,                  
    ...
    BD301004TriggerHandler handler = new BD301004TriggerHandler(Trigger.isExecuting, Trigger.size);   
