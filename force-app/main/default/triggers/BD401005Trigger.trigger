trigger BD401005Trigger on PortalSitePostingProperty__c(before insert, after insert, before update, after update, 					
 before delete, after delete, after undelete) {					
  ...
  BD401005TriggerHandler handler = new BD401005TriggerHandler(Trigger.isExecuting, Trigger.size);	
