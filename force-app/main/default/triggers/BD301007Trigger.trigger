trigger BD301007Trigger on PropertyCodeHistory__c (before insert, after insert, before update, after update,                  
    ...
    BD301007TriggerHandler handler = new BD301007TriggerHandler(Trigger.isExecuting, Trigger.size);   
