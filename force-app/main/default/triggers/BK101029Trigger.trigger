...
trigger BK101029Trigger on FavoriteProperty__c (before insert, after insert, before update, after update, 
before delete, after delete, after undelete) {
 ...
 BK101029TriggerHandler handler = new BK101029TriggerHandler(Trigger.isExecuting, Trigger.size);
