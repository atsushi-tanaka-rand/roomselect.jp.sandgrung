//行動トリガー
trigger BA101008Trigger on Event (before insert, after insert, before update, after update, 					
 before delete, after delete, after undelete) {					
  ...
  BA101008TriggerHandler handler = new BA101008TriggerHandler(Trigger.isExecuting, Trigger.size);	
