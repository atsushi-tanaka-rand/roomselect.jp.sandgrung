...
trigger BK101030Trigger on SendMailInformation__c (before insert, after insert, before update, after update, 
before delete, after delete, after undelete) {
 ...
 BK101030TriggerHandler handler = new BK101030TriggerHandler(Trigger.isExecuting, Trigger.size);
