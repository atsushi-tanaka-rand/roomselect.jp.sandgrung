...
trigger BK101027Trigger on AppointmentReceipt__c (before insert, after insert, before update, after update, 
before delete, after delete, after undelete) {
 ...
 BK101027TriggerHandler handler = new BK101027TriggerHandler(Trigger.isExecuting, Trigger.size);
