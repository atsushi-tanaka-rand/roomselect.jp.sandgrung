//物件トリガ
trigger BD301002Trigger on Property__c (before insert, after insert, before update, after update,                   
 before delete, after delete, after undelete) {                 
  ...
  BD301002TriggerHandler handler = new BD301002TriggerHandler(Trigger.isExecuting, Trigger.size);   
