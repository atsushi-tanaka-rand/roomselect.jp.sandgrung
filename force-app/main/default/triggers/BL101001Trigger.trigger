// LINE会員トリガ
trigger BL101001Trigger on LineMember__c (before insert, after insert, before update, after update, 
	...
	BL101001TriggerHandler handler = new BL101001TriggerHandler(Trigger.isExecuting, Trigger.size);
