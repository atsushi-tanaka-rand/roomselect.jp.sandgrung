...
trigger BE101001Trigger1 on PropertyMaintenanceHistory__c (before insert, after insert, before update, after update, 
 before delete, after delete, after undelete) {
  ...
  BE101001TriggerHandler1 handler = new BE101001TriggerHandler1(Trigger.isExecuting, Trigger.size);
