//日報集計部品（対応トリガー）
trigger BE101001Trigger2 on Correspond__c (before insert, after insert, before update, after update, 
 before delete, after delete, after undelete) {
  ...
  BE101001TriggerHandler2 handler = new BE101001TriggerHandler2(Trigger.isExecuting, Trigger.size);
