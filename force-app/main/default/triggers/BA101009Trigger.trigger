// 店舗異動トリガー
trigger BA101009Trigger on ShopTransfer__c(before insert, after insert, before update, after update, 					
before delete, after delete, after undelete) {					
    ...
    BA101009TriggerHandler handler = new BA101009TriggerHandler(Trigger.isExecuting, Trigger.size);	
